...
public class XmlDslParser extends Parser {
	...
	public static final int
		...
		IMPORT=54, INCLUDE=55, FUN=56, RETURN=57, EXPORT=58, TYPEOF=59, AS=60, 
		AS_SAFE=61, IS=62, NOT_IS=63, VOID=64, ANY=65, NUMBER=66, STRING=67, BOOLEAN=68, 
		LIST=69, ELEMENT=70, NumberLiteral=71, BooleanLiteral=72, NullLiteral=73, 
		Identifier=74, Inside_Comment=75, Inside_WS=76, Inside_NL=77, DOUBLE_QUOTE_CLOSE=78, 
		StrText=79, StrEscapedChar=80, StrRef=81, StrExprStart=82, StrLineNL=83, 
		SINGLE_QUOTE_CLOSE=84, Single_StrLineNL=85, StrExpr_Comment=86, StrExpr_WS=87, 
		StrExpr_NL=88;
	public static final int
		...
		RULE_functionCall = 35, RULE_functionCallParameters = 36, RULE_postfixUnaryOperation = 37, 
		RULE_listAccess = 38, RULE_multiplicativeOperation = 39, RULE_additiveOperator = 40, 
		RULE_inOperator = 41, RULE_comparisonOperator = 42, RULE_equalityOperation = 43, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"whileExpression", "collectionLiteral", "functionCall", "functionCallParameters", 
			"postfixUnaryOperation", "listAccess", "multiplicativeOperation", "additiveOperator", 
			"inOperator", "comparisonOperator", "equalityOperation", "assignmentOperator"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'include'", "'fun'", "'return'", "'export'", "'typeof'", "'as'", "'as?'", 
			"'is'", null, "'void'", "'any'", "'number'", "'string'", "'boolean'", 
			"'list'", "'element'", null, null, "'null'", null, null, null, null, 
			null, null, null, null, "'${'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"EXPORT", "TYPEOF", "AS", "AS_SAFE", "IS", "NOT_IS", "VOID", "ANY", "NUMBER", 
			"STRING", "BOOLEAN", "LIST", "ELEMENT", "NumberLiteral", "BooleanLiteral", 
			"NullLiteral", "Identifier", "Inside_Comment", "Inside_WS", "Inside_NL", 
			"DOUBLE_QUOTE_CLOSE", "StrText", "StrEscapedChar", "StrRef", "StrExprStart", 
			"StrLineNL", "SINGLE_QUOTE_CLOSE", "Single_StrLineNL", "StrExpr_Comment", 
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2216065687028352L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 15L) != 0)) {
				{
				setState(116);
				statement();
				setState(127);
	...
	public final CollectionLiteralContext collectionLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 283124245398144L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 15L) != 0)) {
				{
				setState(432);
				expression();
				}
	...
	public static class FunctionCallParametersContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XmlDslParserListener ) ((XmlDslParserListener)listener).enterFunctionCallParameters(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XmlDslParserListener ) ((XmlDslParserListener)listener).exitFunctionCallParameters(this);
		}
	}
	...
	public final FunctionCallParametersContext functionCallParameters() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_functionCallParameters);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final PostfixUnaryOperationContext postfixUnaryOperation() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_postfixUnaryOperation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(463);
	...
	public final ListAccessContext listAccess() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_listAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(465);
	...
	public final InOperatorContext inOperator() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_inOperator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final EqualityOperationContext equalityOperation() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_equalityOperation);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
